...
.subtract(
    CAG.circle({"center":[252.645575,-142.938897],"radius":1.1})
.union(
    ...
    new CSG.Path2D([[176.993242,-140.3171506],[190.7176442,-138.8746578]]).appendPoint([189.2751514,-125.1502556]).appendPoint([175.5507492,-126.5927484]).appendPoint([176.993242,-140.3171506]).close().innerToCAG()
                ...
                function switchplate_choc_case_fn() {
                    

                // creating part 0 of case switchplate_choc
                let switchplate_choc__part_0 = switchplate_extrude_1_2_outline_fn();

                // make sure that rotations are relative
                let switchplate_choc__part_0_bounds = switchplate_choc__part_0.getBounds();
                let switchplate_choc__part_0_x = switchplate_choc__part_0_bounds[0].x + (switchplate_choc__part_0_bounds[1].x - switchplate_choc__part_0_bounds[0].x) / 2
                let switchplate_choc__part_0_y = switchplate_choc__part_0_bounds[0].y + (switchplate_choc__part_0_bounds[1].y - switchplate_choc__part_0_bounds[0].y) / 2
                switchplate_choc__part_0 = translate([-switchplate_choc__part_0_x, -switchplate_choc__part_0_y, 0], switchplate_choc__part_0);
                switchplate_choc__part_0 = rotate([0,0,0], switchplate_choc__part_0);
                switchplate_choc__part_0 = translate([switchplate_choc__part_0_x, switchplate_choc__part_0_y, 0], switchplate_choc__part_0);

                switchplate_choc__part_0 = translate([0,0,0], switchplate_choc__part_0);
                let result = switchplate_choc__part_0;
            ...
            function main() {
                return switchplate_choc_case_fn();
            }
